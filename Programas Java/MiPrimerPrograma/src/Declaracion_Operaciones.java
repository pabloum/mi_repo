...
public class Declaracion_Operaciones {
	...
	public static void main(String[] args) {
		...
		nombre.charAt(2);//devuelve la letra en la posición 2 de la cadena de caracteres mi_nombre
		/*nombre.substring();//dos parámetros. Es para extraer una parte de la cadena de caracteres, el primer número dice a partir de cual posición extraer y el sgundo hasta cuál posicion quieor extraer
		...
		*/
		...
		System.out.println("la última letra de mi nombre es la "+nombre.charAt(ult_letra));
		
		String frase="Había una vez un barco chiquito buahahahha";
