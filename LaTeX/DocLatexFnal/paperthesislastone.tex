...
\author{ Mariana Correa-\'Alvarez.\and Valentina Villada-Quiceno.        \and Juli\'an Sierra-P\'erez \and Juan Guillermo Garc\'ia-Navarro.
         %etc.
}

\authorrunning{Correa-\'Alvarez, Villada-Quiceno, Sierra-P\'erez, Garc\'ia-Navarro} % if too long for running head

\institute{Grupo de Investigaci\'on en Ingenier\'ia Aeroespacial\\ Universidad Pontificia Bolivariana \at
...
%\date{Received: Noviembre 11 de 2015 / Accepted: Noviembre 11 de 2015}
...
\caption{Engineering constants obtained}  %Please write your table caption here}
...
\begin{table}[H]
% table caption is above the table
\caption{Maximum Strength and Strain obtained}  %tests  %Please write your table caption here}
...
\begin{table}[H]
% table caption is above the table
\caption{Interlaminar Fracture Toughness}  %Please write your table caption here}
...
\begin{table}[H]
% table caption is above the table
\caption{Error Percentages (Unidirectional carbon fiber) \cite{pcl} \cite{navarro}  }  %tests  %Please write your table caption here}
...
\begin{table}[H]
% table caption is above the table
\caption{Error Percentages (Woven) \cite{pcl} \cite{navarro}}  %tests  %Please write your table caption here}
...
\begin{table}[H]
% table caption is above the table
\caption{Error Percentages (Fracture Toughness) \cite{zu} }  %Please write your table caption here}
...
% Use the relevant command to insert your figure file.
% For example, with the graphicx package use
  \includegraphics[width=0.45\textwidth]{vali}%antesde{}
% figure caption is below the figure
...
% Use the relevant command to insert your figure file.
% For example, with the graphicx package use
  \includegraphics[width=0.45\textwidth]{Rotor}%{Rotor}%antesde{}
% figure caption is below the figure
